                        ...
                        <form action="/tag/{{ $tag->id }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <select id="style" name="style" class="form-select w-50">
                                    <option selected>{{ old('style') ?? $tag->style }}</option>
                                ...
                                {{-- <input type="text"
                                       ...
                                       id="style" name="style" value="{{ old('style') ?? $tag->style }}">
                                <small class="form-text text-danger">{!! $errors->first('style') !!}</small> --}}
                            </div>
                            <input class="btn btn-success mt-4" type="submit" value="Tag bearbeiten">
                        </form>
